    ...
    <Layout>
      ...
      <section className="container py-6 flex flex-col sm:flex-row sm:items-start gap-10">
        ...
        <div className="space-y-4">
          <h1 className="text-4xl mb-6 leading-snug font-black text-gray-800">
          ...
          <p className="text-lg leading-8 text-gray-600">
            ...
            where I focus on making playful and fun experience. Before that, I
          ...
          <p className="text-lg leading-8 text-gray-600">
            Since 2017, I have collaborated with Shawn Wang in creating several
            WeChat mini-applications including the{" "}
          ...
          <p className="text-lg leading-9 text-gray-600">
            ...
            designer, I build fun product & experience that brings happiness to
            daily life.
          </p>

          <div>
            <h2 className="mt-8 text-xl font-semibold text-gray-800">Skills</h2>
            <ul className="text-lg list-none space-y-1 mt-4">
              <ListItem icon={<FiMonitor />}>
                UI/UX Design, Visual Design, Storyboarding, Prototyping
              </ListItem>
              <ListItem icon={<FiCode />}>
                Front-end web, Node.js, Arduino, C++, Python
              </ListItem>
              <ListItem icon={<FiTool />}>
                CAD/CAM for fabrication, Wood working, Soldering
              </ListItem>
            </ul>
          </div>
        </div>
