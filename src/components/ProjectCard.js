...
const Project = ({
  ...
  return (
    <Link className="group" to={path}>
      ...
      >
        <div className="py-5 px-6 md:py-6 md:px-8 lg:py-7 lg:px-9 flex min-w-min flex-col justify-between text-gray-800">
          <div>
            <h2 className="text-xl font-extrabold">{title}</h2>
            <p className="mt-2 text-base text-gray-600">{description}</p>
            <p className="hidden md:flex items-center mt-2 space-x-0.5 text-sm text-gray-400">
              <span>Read more</span>
